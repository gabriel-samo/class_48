...
function MainPage(): JSX.Element {
    ...
    let myDevice2 = [
        { id: 1, nodeId: 10, name: "entrance", location: "main-floor", epId: 21 },
        { id: 2, nodeId: 11, name: "dinning", location: "main-floor", epId: 22 },
        { id: 3, nodeId: 12, name: "kitchen", location: "main-floor", epId: 23 },
        { id: 4, nodeId: 15, name: "pool", location: "garden", epId: 24 },
        { id: 5, nodeId: 17, name: "master-bedroom", location: "secondary-floor", epId: 25 },
    ]
    return (
        <div className="MainPage">
            ...
            />)} */}
            {myDevice2.map(item => <Gang2
                key={item.id} nodeId={item.nodeId} name={item.name} location={item.location} epId={item.epId}
            />)}
        </div>
    );
}
