...
const CARBOOM_URL =
  "https://data.gov.il/api/3/action/datastore_search?resource_id=4a434d65-3ca2-45e5-8026-5d9819c3f95c&q=";
...
const carBoomInfo = async (id: string) => {
  let myData = (await axios.get(CARBOOM_URL + id)).data.result.records[0];
  return myData;
};

export { carInfo, bikeInfo, truckInfo, carBoomInfo };
